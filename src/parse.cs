namespace System.Text
{
    ...
    public static class Html
    {
        ...
        static void parseInstruction(string tagName, ref int i, int len, string HTML)
        {
            while (i < len && HTML[i] != '>')
            {
                while (i < len && char.IsWhiteSpace(HTML[i]))
                {
                    i++;
                }
        ...
        static void parseAttributes(string tagName, ref int i, int len, string HTML,
            Action<string> href)
        {
            while (i < len && char.IsWhiteSpace(HTML[i]))
            {
            ...
            while (i < len && char.IsLetter(HTML[i]))
            {
                int start = i;
                ...
                if (i > start)
                {
                    string attrName = HTML.Substring(start, i - start); string attrVal = null;
                    ...
                    if (i < len && HTML[i] == '=')
                    {
                        ...
                        if (i < len && (HTML[i] == '\"' || HTML[i] == '\''))
                        {
                            ...
                            attrVal = HTML.Substring(start, i - start);
                        ...
                        else
                        {
                            ...
                            while (i < len && !char.IsWhiteSpace(HTML[i]) && HTML[i] != '<' && HTML[i] != '>')
                            {
                                i++;
                            }
        ...
        static bool endOfScript(int i, int len, string HTML)
        {
            if (i < len && HTML[i++] == '<')
            {
                if (i < len && HTML[i++] == '/')
                {
                    if (i < len && (HTML[i] == 's' || HTML[i] == 'S'))
                    {
                        i++;
                        if (i < len && (HTML[i] == 'c' || HTML[i] == 'C'))
                        {
                            i++;
                            if (i < len && (HTML[i] == 'r' || HTML[i] == 'R'))
                            {
                                i++;
                                if (i < len && (HTML[i] == 'i' || HTML[i] == 'I'))
                                {
                                    i++;
                                    if (i < len && (HTML[i] == 'p' || HTML[i] == 'P'))
                                    {
                                        i++;
                                        if (i < len && (HTML[i] == 't' || HTML[i] == 'T'))
                                        {
                                            return true;
                                        }
                                    }
        ...
        public static void parse(string HTML,
            Action<string, char> tag, Action<string> title, Action<string> text, Action<string> href)
        {
            if (HTML == null)
            {
                return;
            ...
            int i = 0; int len = HTML.Length;

            while (i >= 0 && i < len)
            {
                int start = i; char c = HTML[i++];
                ...
                switch (c)
                {
                    case '<':
                        ...
                        if (tagType == '!' || tagType == '/' || tagType == '<')
                        {
                            ...
                            while (i < len && char.IsLetterOrDigit(HTML[i]))
                            {
                                i++;
                            }
                            ...
                            if (i > tagStart)
                            {
                                string tagName = HTML.Substring(tagStart, i - tagStart);

                                switch (tagType)
                                {
                                    case '!':
                                        parseInstruction(tagName, ref i, len, HTML);
                                        break;

                                    case '<':
                                        parseAttributes(tagName, ref i, len, HTML, href);
                                        break;
                                }
                                ...
                                if (tagType == '<' && string.Equals(tagName, "SCRIPT", StringComparison.OrdinalIgnoreCase))
                                {
                                    ...
                                    string eval = HTML.Substring(scriptStart, scriptEnd - scriptStart);
                                ...
                                else
                                {
                                    ...
                                    if (tagType == '<' && string.Equals(tagName, "TITLE", StringComparison.OrdinalIgnoreCase))
                                    {
                                        start = i;
                                        ...
                                        if (title != null)
                                        {
                                            title(HTML.Substring(start, i - start));
                                        }
                                    } 
                                }
                            }
                            else
                            {
                                ...
                                {
                                    text(HTML.Substring(start, i - start));
                                }                                
                            }
                        }
                        else
